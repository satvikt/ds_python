...
def get_lat_long_range(latitude, longitude):
    """
...
def determine_location_max_brightness():
    ...
    brightest_sf = ["San Francisco", fireball(delphix_sf[0], delphix_sf[1])]
    ...
    if city_list:
        ...
        result = f"Location with maximum brightness: {location_max_brightness[0]}"
